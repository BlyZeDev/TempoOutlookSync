...
public sealed record OutlookAppointmentInfo
{
    ...
    public OutlookAppointmentInfo(TempoPlannerEntry tempoEntry, JiraIssue jiraIssue, OutlookCategory? category)
    {
        TempoEntry = tempoEntry;
    ...
    public OutlookAppointmentInfo(TempoPlannerEntry tempoEntry, JiraProject jiraProject, OutlookCategory? category)
    {
        TempoEntry = tempoEntry;
